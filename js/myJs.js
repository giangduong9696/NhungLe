const textConfig = {
  text1: "Hello Pé Pắp!",
  text2: "Anh có cái này cho em xem ^^",
  text3: "Hôm nay không là ngày gì cả chỉ muốn chúc em vui vẻ, xinh đẹp, dễ chương, luôn hoàn thành các kì thi thật tốt nhá",
  text4: "Em thấy trai Nam Định viết văn oke khôm",
  text6: "Toẹt vời!!!",
  text5: "Dở tệ á =))",
  text7: "Anh cũng có dự định cho năm 2023 về công việc những chuyến đi, và cả những chiếc áo đôi nữa, em có muốn tham gia cùng anh không :vvvv",
  text8: "Gửi cho anh <3",
  text9: "Em đồng ý hai tay hai chân luôn",
  text10: "Anh biết mà ^^",
  text11:
    "Anh rất vui vì mình đã kết bạn với nhau thời gian sắp tới 2 đứa mình cùng đi chơi Thái Nguyên nhé",
  text12: "<3 <3 <3",
};
